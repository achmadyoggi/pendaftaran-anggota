...
<html>
    ...
    <body>
        <header>
            <h1 a href="beranda.php">Admin Organisasi</h1>
            <ul>
                <li><a href="beranda.php">Beranda</a></li>
                <li><a href="data-peserta.php">Data Anggota Baru</a></li>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="hapus-peserta.php?id=<?php echo $row['id_pendaftaran']?>" onclick="return confirm ('Apakah anda beniat untuk menghapus ?')">Delete</a>
                            </td>
                        </tr>
                        <?php 
                        }?>
